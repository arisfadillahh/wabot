          ...
          <div className="lg:hidden border-t border-gray-200 dark:border-gray-800 bg-background/95 backdrop-blur">
            <div className="container px-4 py-3">
              ...
              <div className="grid grid-cols-4 gap-2">
                <Button variant="ghost" size="sm" className="flex-col h-auto py-3 relative">
                ...
                <Button variant="ghost" size="sm" className="flex-col h-auto py-3 relative">
                  ...
                  {unreadNotifications > 0 && (
                    <Badge variant="destructive" className="absolute -top-1 -right-1 w-4 h-4 p-0 text-xs flex items-center justify-center">
                      {unreadNotifications > 99 ? '99+' : unreadNotifications}
                    </Badge>
                  )}
                </Button>
                ...
                <Button variant="ghost" size="sm" className="flex-col h-auto py-3 relative" onClick={handleLogout}>
